...
<script id="js">
 ...
 var g = new dagreD3.graphlib.Graph()
    ...
    link.textContent = '根据出差地点及出差人员信息以邮件形式发送给当地HR';
    tspan.appendChild(link);
    svg_label.appendChild(tspan);

    g.setNode(0,  { label: svg_label, labelType: 'svg' });
    g.setNode(1,  { label: "待当地HR与代理确认完成预定" });
    g.setNode(2,  { label: "当地HR回复邮件并抄送出差人员（部分当地酒店需由Ravic审批后方可预定）" });
    g.setNode(3,  { label: "费用需由个人到前台现付并自行拿发票走报销流程" });
