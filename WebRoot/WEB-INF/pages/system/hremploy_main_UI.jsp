...
<section class="content">
	...
	<table id="employ_table" class="table-condensed table tablse-hover" data-row-style="rowStyle"
...
<script type="text/javascript">
	...
	$(document).on("click", "#employ_add", function() {
		var href = $.webapp.root + '/admin/system/employ/hremploy_form_UI.do';
	...
	$.BOOT.click(".employ_edit", function(c) {
		...
		var href = $.webapp.root
				+ '/admin/system/employ/hremploy_form_UI.do?id=' + id;
		$.BOOT.page("content_addEmploy", href, function() {
			$('#addEmployModal').modal('toggle');
		});
	});
