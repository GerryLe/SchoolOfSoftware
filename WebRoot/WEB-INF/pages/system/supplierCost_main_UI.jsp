...
<script id="js">
 ...
 var g = new dagreD3.graphlib.Graph()
    ...
    link.textContent = '整理人员名单';
    tspan.appendChild(link);
    svg_label.appendChild(tspan);

    g.setNode(0,  { label: svg_label, labelType: 'svg' });
    g.setNode(1,  { label: "与项目文员核对员工工时" });
    g.setNode(2,  { label: "计算供应商服务费）" });
    g.setNode(3,  { label: "发出费用申请邮件至项目PM审批" });
    g.setNode(4,  { label: "发送至Shadow审批" });
    g.setNode(5,  { label: "发送至May审批" });
    g.setNode(6,  { label: "递单给财务（填写费用报销单）" });
    g.setNode(7,  { label: "汇款至供应商" });
