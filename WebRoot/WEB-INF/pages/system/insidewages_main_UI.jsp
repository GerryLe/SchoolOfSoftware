...
<script id="js">
 ...
 var g = new dagreD3.graphlib.Graph()
    ...
    link.textContent = '各地HR提交动态表';
    tspan.appendChild(link);
    svg_label.appendChild(tspan);

    g.setNode(0,  { label: svg_label, labelType: 'svg' });
    g.setNode(1,  { label: "广州HR" });
    g.setNode(2,  { label: "汇总各地动态表" });
    g.setNode(3,  { label: "各地HR导出考勤数据（每月21号）" });
    g.setNode(4,  { label: "员工及主管" });
    g.setNode(5,  { label: "各地HR反馈考勤情况" });
    g.setNode(6,  { label: "广州HR制作考勤表" });
    g.setNode(7,  { label: "人力资源经理Shadow" });
    g.setNode(8,  { label: "制作工资表" });
    g.setNode(9,  { label: "May审批" });
    g.setNode(10,  { label: "Ravic批复" });
    g.setNode(11,  { label: "银行发放工资" });
    ...
    edge_link.textContent = '每月21号前发送邮件';
    edge_tspan.appendChild(edge_link);
    svg_edge_1.appendChild(edge_tspan);
     
    svg_edge_27 = document.createElementNS('http://www.w3.org/2000/svg', 'text');
    edge_tspan = document.createElementNS('http://www.w3.org/2000/svg','tspan');
    edge_tspan.setAttributeNS('http://www.w3.org/XML/1998/namespace', 'xml:space', 'preserve');
    edge_tspan.setAttribute('dy', '1em');
    edge_tspan.setAttribute('x', '1');
    ...
    edge_link.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href', 'http://google.com/');
    edge_link.setAttribute('target', '_blank');
    edge_link.textContent = '每月22号前';
    edge_tspan.appendChild(edge_link);
    svg_edge_27.appendChild(edge_tspan);
    ...
    edge_link.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href', 'http://google.com/');
    edge_link.setAttribute('target', '_blank');
    edge_link.textContent = '签字确认';
    edge_tspan.appendChild(edge_link);
    svg_edge_5.appendChild(edge_tspan);
    
    svg_edge_67 = document.createElementNS('http://www.w3.org/2000/svg', 'text');
    edge_tspan = document.createElementNS('http://www.w3.org/2000/svg','tspan');
    edge_tspan.setAttributeNS('http://www.w3.org/XML/1998/namespace', 'xml:space', 'preserve');
    edge_tspan.setAttribute('dy', '1em');
    edge_tspan.setAttribute('x', '1');
    ...
    edge_link.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href', 'http://google.com/');
    edge_link.setAttribute('target', '_blank');
    edge_link.textContent = '每月24号前';
    edge_tspan.appendChild(edge_link);
    svg_edge_67.appendChild(edge_tspan);
    ...
    edge_link.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href', 'http://google.com/');
    edge_link.setAttribute('target', '_blank');
    edge_link.textContent = 'Ravic通过审批 每月7号前';
    edge_tspan.appendChild(edge_link);
    ...
    g.setEdge(1, 2);
    g.setEdge(2, 7, { labelType: "svg", label: svg_edge_27 });
    g.setEdge(3, 4, { labelType: "svg", label: svg_edge_4 });
    g.setEdge(4, 5, { labelType: "svg", label: svg_edge_5 });
    g.setEdge(5, 6);
    g.setEdge(6, 7, { labelType: "svg", label: svg_edge_67 });
    g.setEdge(7, 8);
    g.setEdge(8, 9);
    g.setEdge(9, 10);
    g.setEdge(7, 11, { labelType: "svg", label: svg_edge_11 });
