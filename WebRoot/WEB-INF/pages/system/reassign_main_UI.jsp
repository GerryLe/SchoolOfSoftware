...
<script id="js">
 ...
 var g = new dagreD3.graphlib.Graph()
    ...
    link.textContent = '新部门主管提出申请';
    tspan.appendChild(link);
    svg_label.appendChild(tspan);

    g.setNode(0,  { label: svg_label, labelType: 'svg' });
    g.setNode(1,  { label: "新部门负责人" });
    g.setNode(2,  { label: "人力资源经理Shadow" });
    g.setNode(3,  { label: "人力资源总监May" });
    g.setNode(4,  { label: "Ravic" });
    g.setNode(5,  { label: "员工签字确认（动态表及相关文书）" });
