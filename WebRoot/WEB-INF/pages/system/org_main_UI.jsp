...
<jsp:include page="/template/modal.jsp"><jsp:param value="addorgs" name="id" /><jsp:param value="编辑部门" name="title" /></jsp:include>
			...
			<td style="width: 50%;vertical-align: top;">
				<div id="filter-bar">
					<div class="form-inline" role="form">
						<button type="button" class="btn btn-primary org_edit" id="org_edit_idd"><spring:message code="add" /></button>
					</div>
				</div>
