...
<script id="js">
 ...
 var g = new dagreD3.graphlib.Graph()
    ...
    link.textContent = '将文具申购表格分配各部门';
    tspan.appendChild(link);
    svg_label.appendChild(tspan);

    g.setNode(0,  { label: svg_label, labelType: 'svg' });
    g.setNode(1,  { label: "收集表格整理需求给代理" });
    g.setNode(2,  { label: "待文具送到后通知各部门领取" });
    g.setNode(3,  { label: "领取文具（需签名确认）" });
