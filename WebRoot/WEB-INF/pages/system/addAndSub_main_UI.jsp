...
<script id="js">
 ...
 var g = new dagreD3.graphlib.Graph()
    ...
    link.textContent = '汇总上月入职人员信息';
    tspan.appendChild(link);
    svg_label.appendChild(tspan);

    g.setNode(0,  { label: svg_label, labelType: 'svg' });
    g.setNode(1,  { label: "正确填写增减员表" });
    g.setNode(2,  { label: "正确填写增减员表" });
    g.setNode(3,  { label: "前程无忧Rainbox,抄送Shadow及May及各地前程专员" });
    g.setNode(4,  { label: "提供新入职员工相关资料" });
    g.setNode(5,  { label: "前程" });
    g.setNode(6,  { label: "核对账单" });
    g.setNode(7,  { label: "确认账单" });
    ...
    edge_link.textContent = '外包 所有入离职转掉人员、';
    ...
    edge_link.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href', 'http://google.com/');
    edge_link.setAttribute('target', '_blank');
    edge_link.textContent = '非外包  购买五险一金人员';
    edge_tspan.appendChild(edge_link);
    ...
    edge_link.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href', 'http://google.com/');
    edge_link.setAttribute('target', '_blank');
    edge_link.textContent = '每月10号前提供';
    edge_tspan.appendChild(edge_link);
    ...
    edge_link.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href', 'http://google.com/');
    edge_link.setAttribute('target', '_blank');
    edge_link.textContent = '每月12号前提供';
    edge_tspan.appendChild(edge_link);
    ...
    edge_link.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href', 'http://google.com/');
    edge_link.setAttribute('target', '_blank');
    edge_link.textContent = '提供补缴、备案等资料';
    edge_tspan.appendChild(edge_link);
    ...
    g.setEdge(1, 3, { labelType: "svg", label: svg_edge_13 });
