...
<script src="<%=basePath %>/template/resource/js/bootstrap.js"></script>
...
$(function() {
	$(document).on("click", "#indexloat", function() {
		 
		 //判断当前页面是否有父页面
		 if(self==top){
			 window.open('/admin/index/index.do');
		 }else{
...
<body>
	<div class="demo">
		...
		<p >该页面不存在(´･ω･`)<span id="indexloat" style="color: blue;cursor: pointer;">返回首页</span></p>
	</div>
</body>
