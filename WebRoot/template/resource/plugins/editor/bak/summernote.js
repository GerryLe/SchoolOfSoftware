  ...
  var EventHandler = function () {
    ...
    this.insertImages = function (layoutInfo, files) {
      ...
      if (callbacks.onImageUpload) {
        bindCustomEvent($holder, callbacks, 'image.upload')(files,options.formid);
  ...
  var Renderer = function () {
    ...
    var tplDialogInfo = {
      image: function (lang, options) {
        ...
        options.formid = "form_"+parseInt(Math.random()*10000);
        var body = '<div class="form-group row note-group-select-from-files"><form id='+options.formid+'>' +
