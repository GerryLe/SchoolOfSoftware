...
public class UserAgent {
	...
	public String toString() {
		return "UserAgent [browserType=" + browserType + ", browserVersion=" + browserVersion + ", platformType=" + platformType
				+ ", platformSeries=" + platformSeries + ", platformVersion=" + platformVersion + "]";
	}
