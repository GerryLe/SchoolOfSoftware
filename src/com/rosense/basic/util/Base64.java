...
public class Base64 {
	...
	public static String encodeStringNew(final String str) {
		String s = encodeToString(str.getBytes(), true);
		s = s.replaceAll("=", "new");
		return s;
	}

	public static String decodeStringNew(String str) {
		str = str.replaceAll("new", "=");
		String s = new String(decode(str));
		return s;
	}
