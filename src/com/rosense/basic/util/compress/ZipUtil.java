package com.rosense.basic.util.compress;
...
public class ZipUtil {
	 ...
	 */
	public void testZip() {
		File srcFile = new File("D:\\work\\test");// 要压缩的文件对象
		File targetZipFile = new File("D:\\work\\test.zip");// 压缩后的文件名
