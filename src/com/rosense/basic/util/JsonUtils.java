...
public class JsonUtils {
	...
	public static String stock2json(List<Map<String, Object>> stockMap) {
		StringBuilder json = new StringBuilder("{\"data\":[");
		int i = 0;
		for (Map<String, Object> map : stockMap) {
			json.append("[").append(StringUtil.joinString(map.values(), ",")).append("]");
			if (i++ != stockMap.size() - 1) {
				json.append(",");
			}
		}
		json.append("]}");
	...
	public static String object2json(Object obj) {
		...
		if (obj == null) {
			json.append("\"\"");
		} else if (obj instanceof Integer || obj instanceof Float || obj instanceof Boolean || obj instanceof Short || obj instanceof Double
