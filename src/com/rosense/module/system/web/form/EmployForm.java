...
public class EmployForm extends PageHelper implements Serializable {
...
//	private int approval;//人事审批(0：不通过，1：通过)
	...
	private String userRoleSn; //用户角色
	private int userDefaultRole; //用户默认角色号
	...
	public void setUserDefaultRole(int userDefaultRole) {
