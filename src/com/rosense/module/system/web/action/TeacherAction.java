...
public class TeacherAction extends BaseController {
	...
	public String userrole_main_UI(String id, Model model) {
		...
		UserForm form = this.teacherService.get(id);
		if (form != null) {
	...
	public Msg add(UserForm form) throws Exception {
		return this.teacherService.addTea(form);
	}
	...
	public Msg delete(UserForm form) throws Exception {
		return this.teacherService.delete(form);
	}
	...
	*/
	...
	public Msg lockUser(String id) {
		return this.teacherService.lockUser(id);
	}
	...
	public Msg resetPwd(String id) {
		return this.teacherService.resetPwd(id);
	}
	...
	public Msg update(UserForm form) throws Exception {
		return this.teacherService.update(form);
	}

	@RequestMapping("/get.do")
	@ResponseBody
	public UserForm get(UserForm form) throws Exception {
		return this.teacherService.get(form.getId());
	}
	...
	public DataGrid datagridperson(UserForm form,String selectType,String searchKeyName) throws Exception {
		return this.teacherService.datagridperson(form,selectType,searchKeyName);
	}
	...
	public DataGrid commondatagridperson(UserForm form,String selectType,String searchKeyName) throws Exception {
		return this.teacherService.commondatagridperson(form,selectType,searchKeyName);
	}
	...
	public DataGrid datagridleaveperson(UserForm form) throws Exception {
		return this.teacherService.datagridleaveperson(form);
	}
	...
	public DataGrid datagrid_ref(UserForm form) throws Exception {
		...
		return this.teacherService.datagrid_ref(form);
	}
		...
		if (request instanceof MultipartHttpServletRequest) {
			...
			try {
				...
				if (files.size() > 0) {
					...
					Msg msg = this.teacherService.updatePhoto(path + newName);
	...
	public Msg updatepwd(UserForm form) {
		return this.teacherService.updatePwd(form);
	}
	...
	public Msg batchRole(UserForm form) {
		return this.teacherService.batchUserRole(form);
	}
	...
	public Msg no_adduserrole(String roleId, String userIds) throws Exception {
		return this.teacherService.addRoleForUser(roleId, userIds);
	}
	...
	public Msg deleteuserrole(String roleId, String userId) throws Exception {
		return this.teacherService.deleteRoleForUser(roleId, userId);
	}
	...
	public Msg adduserorg(String orgId, String userIds) throws Exception {
		return this.teacherService.addOrgForUser(orgId, userIds);
	}
	...
	public Msg deleteuserorg(String userId) throws Exception {
		return this.teacherService.deleteOrgForUser(userId);
	}
	...
	public Msg adduserposition(String positionId, String userIds) throws Exception {
		return this.teacherService.addPositionForUser(positionId, userIds);
	}
	...
	public Msg deleteuserposition(String userId) throws Exception {
		return this.teacherService.deletePositionForUser(userId);
	}
...
/*	@RequestMapping("/checkUserAccount.do")
            ...
            if (null != hSheet){  
                for (int i = 1; i < hSheet.getPhysicalNumberOfRows(); i++){  
                    ...
                    if(!StringUtil.isEmpty(hRow.getCell(1).toString())){
                        ...
                        OrgForm orgform=classService.getId(hRow.getCell(2).toString());
                        su.setOrgId(orgform.getId());
                        }
                        if(!StringUtil.isEmpty(hRow.getCell(3).toString())){
                        OrgForm orgform2=classService.getId(hRow.getCell(3).toString());
        ...
        try {
            ...
            if (null != xSheet) {
                for (int i = 1; i < xSheet.getPhysicalNumberOfRows(); i++) {
                    ...
                    OrgForm orgform=classService.getId(xRow.getCell(2).toString());
                    su.setOrgId(orgform.getId());
                    }
                    if(!StringUtil.isEmpty(xRow.getCell(3).toString())){
                    OrgForm orgform2=classService.getId(xRow.getCell(3).toString());
                    su.setOrgChildId(orgform2.getId());
                    }
	...
	*/
	...
	public DataGrid datagridpersonal() throws Exception {
		return this.teacherService.datagridpersonal();
	}
	...
	public List<UserForm> chargeTree(){
		return teacherService.chargeTree();
	}
} 
